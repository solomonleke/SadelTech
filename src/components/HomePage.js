...
export default function HomePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Agile development processes and seamless team integration"
    },
    {
      icon: <Award size={24} />,
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 backdrop-blur-md bg-gray-50 dark:bg-gray-900 border-b border-gray-200/20 dark:border-gray-700/20">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/" className={`${theme.text.primary} hover:text-blue-600 transition-colors font-medium`}>Home</Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className={`text-xl leading-relaxed mb-8 ${theme.text.secondary} max-w-lg`}>
                We create innovative technology solutions that drive business growth and deliver exceptional user experiences.
              </p>
