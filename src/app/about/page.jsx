...
export default function AboutPage() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Expert in React, Next.js, and modern frontend technologies.",
      image: "/api/placeholder/300/400"
    },
    {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4 backdrop-blur-md bg-white/80 dark:bg-gray-900/80 border-b border-gray-200/20 dark:border-gray-700/20">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="/about" className={`${theme.text.primary} hover:text-blue-600 transition-colors font-medium`}>About</a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6">
                About <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Sadel</span>
              </h1>
              <p className={`text-xl leading-relaxed mb-8 ${theme.text.secondary}`}>
                We are a passionate team of technology experts dedicated to building innovative digital solutions 
                that transform businesses and create exceptional user experiences.
              </p>
              <p className={`leading-relaxed mb-8 ${theme.text.secondary}`}>
                Founded in 2019, Sadel has grown from a small startup to a trusted technology partner for 
                companies worldwide. Our expertise spans web development, mobile applications, cloud solutions, 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className={`p-8 rounded-2xl border ${theme.bg.border} hover:shadow-xl transition-all duration-300 group hover:scale-105 bg-white dark:bg-gray-800/50 text-center`}>
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                Why Choose <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Sadel?</span>
              </h2>
              <p className={`text-xl leading-relaxed mb-8 ${theme.text.secondary}`}>
                Our track record speaks for itself. We've consistently delivered high-quality solutions 
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl p-8 backdrop-blur-sm border border-gray-200/20 dark:border-gray-700/20">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className={`${theme.text.secondary} text-sm`}>Satisfaction Rate</div>
                  </div>
                </div>
              </div>
            </div>
